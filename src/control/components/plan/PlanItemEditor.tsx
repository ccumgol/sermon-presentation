          ...
          {current.type === 'divider' && (
            <>
              <div className="row detail-controls">
                ...
                {/*
                  **켠 뒤에 무엇이 생기는지 적는다.** 체크만 하고 목록으로 돌아가면
                  어디를 눌러야 시작하는지 알 수 없다 — 실제로 그래서 '▶ 를 눌러도
                  안 된다' 는 신고가 있었다 (2026-09-01).
                */}
                <span className="hintline muted">
                  {current.auto
                    ? '순서 목록의 이 구분 행에서 ▶ 를 누르면 시작합니다.'
                    : '켜면 이 구분 행에 ▶ 가 생기고, 그것으로 시작합니다.'}
                </span>
              </div>
